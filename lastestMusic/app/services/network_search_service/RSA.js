// ============ 常量 ============
var maxDigits, ZERO_ARRAY, bigZero, bigOne
var biRadixBase = 2
var biRadixBits = 16
var biRadix = 65536
...
// ============ 入口函数 ============
function getEncSecKey(text) {
    try {
        setMaxDigits(131);
        var rsaKey = new RSAKeyPair(
            "010001",
            "",
            ""
        );
        return encryptedString(rsaKey, text);
    } catch(e) {
...
// ============ 执行 ============
var text = process.argv[2] || "GuGTIppgmQ4aoY3I";
console.log(getEncSecKey(text));